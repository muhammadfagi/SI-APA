...
class JudulMahasiswaBimbing extends StatefulWidget {
  const JudulMahasiswaBimbing({Key? key}) : super(key: key);

  @override
  State<JudulMahasiswaBimbing> createState() => _JudulMahasiswaBimbingState();
}

class _JudulMahasiswaBimbingState extends State<JudulMahasiswaBimbing> {
                                                    ...
                                                    IconButton(
                                                      onPressed: () {
                                                        Navigator.push(context, MaterialPageRoute(builder: (context) {
                                                          return DetailJudulMahasiswaBimbing(nomor: "${snapshot.data[index]["NOMOR"]}");
                                                        }));
                                                      },
