...
class DetailJudulMahasiswaBimbing extends StatefulWidget {
  final String nomor;
  const DetailJudulMahasiswaBimbing({Key? key, required this.nomor}) : super(key: key);

  @override
  State<DetailJudulMahasiswaBimbing> createState() => _DetailJudulMahasiswaBimbingState();
}

class _DetailJudulMahasiswaBimbingState extends State<DetailJudulMahasiswaBimbing> {
