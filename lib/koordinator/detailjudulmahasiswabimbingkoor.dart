...
import 'package:siapa/koordinator/judulmahasiswabimbingkoor.dart';
import 'dart:convert' as convert;
import 'dart:async';
import '../models/namadosen.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailJudulMahasiswaBimbingKoor extends StatefulWidget {
  final String nomor;
  const DetailJudulMahasiswaBimbingKoor({Key? key, required this.nomor}) : super(key: key);

  @override
  State<DetailJudulMahasiswaBimbingKoor> createState() => _DetailJudulMahasiswaBimbingKoorState();
}

class _DetailJudulMahasiswaBimbingKoorState extends State<DetailJudulMahasiswaBimbingKoor> {
          ...
          onPressed: () {
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) {
                  return JudulMahasiswaBimbingKoor();
                }));
          },
        ),
