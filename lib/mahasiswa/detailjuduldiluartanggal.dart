...
class DetailJudulLuarTanggal extends StatefulWidget {
  final String nomor;
  const DetailJudulLuarTanggal({Key? key, required this.nomor}) : super(key: key);

  @override
  State<DetailJudulLuarTanggal> createState() => _DetailJudulLuarTanggalState();
}

class _DetailJudulLuarTanggalState extends State<DetailJudulLuarTanggal> {
                              ...
                              Container(
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    //       context: context,
                                    //       builder: (BuildContext context) =>
                                    //           _buildPopupPembimbing(cont  ext),
                                    //     );
                                    //   },
                                    //   icon: Icon(Icons.edit_outlined),
                                    //   color: Color(0xFF578BB8),
